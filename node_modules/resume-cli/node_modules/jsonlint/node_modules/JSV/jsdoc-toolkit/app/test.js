...
var testCases = [
	...
	function() {
		...
		is('symbols.getSymbol("mdl-card mdl-shadow--2dp.holder").name', "holder", 'Static namespace name can be found.');
		is('symbols.getSymbol("mdl-card mdl-shadow--2dp.holder.foo").name', "foo", 'Static namespace method name can be found.');
		is('symbols.getSymbol("mdl-card mdl-shadow--2dp.holder").isStatic', true, 'Static namespace method is static.');
		
		is('symbols.getSymbol("mdl-card mdl-shadow--2dp.holder.counter").name', "counter", 'Instance namespace property name set on "this" can be found.');
		is('symbols.getSymbol("mdl-card mdl-shadow--2dp.holder.counter").alias', "mdl-card mdl-shadow--2dp.holder.counter", 'Instance namespace property alias set on "this" can be found.');
		is('symbols.getSymbol("mdl-card mdl-shadow--2dp.holder.counter").memberOf', "mdl-card mdl-shadow--2dp.holder", 'Static namespace property memberOf set on "this" can be found.');
	}
	,
	function() {
