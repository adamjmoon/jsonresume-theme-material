...
function publish(symbolSet) {
	...
	IO.copyFile(publish.conf.templatesDir+"/"+publish.conf.stylesheetsDir+"mdl-card mdl-shadow--2dp_noise.gif", publish.conf.outDir+"/"+publish.conf.stylesheetsDir);
	IO.copyFile(publish.conf.templatesDir+"/"+publish.conf.stylesheetsDir+"mdl-card mdl-shadow--2dp_wrapper_noise.gif", publish.conf.outDir+"/"+publish.conf.stylesheetsDir);
